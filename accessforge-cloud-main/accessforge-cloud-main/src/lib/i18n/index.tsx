...
export const dict = {
  ...
  "top.theme": { ar: "المظهر", en: "Theme" },
  "top.theme_light": { ar: "فاتح", en: "Light" },
  "top.theme_system": { ar: "حسب النظام", en: "System" },
  "top.theme_dark": { ar: "داكن", en: "Dark" },
  ...
  "mod.view": { ar: "عرض", en: "View" },
  "mod.run": { ar: "تشغيل", en: "Run" },
  "mod.locked": { ar: "مقفل", en: "Locked" },
  "mod.filter_all": { ar: "الكل", en: "All" },
  ...
  "copilot.greeting": { ar: "مرحباً، {name}", en: "Hello, {name}" },
  "copilot.greeting_sub": { ar: "كيف أساعدك في العمليات اليوم؟", en: "How can I help with ops today?" },
  "copilot.suggest.crew_hours_sub": { ar: "حدود الخدمة والراحة لأي عضو طاقم", en: "Duty and rest limits for any crew member" },
  "copilot.suggest.heavy_status_sub": { ar: "حالة فحص الصيانة الثقيلة الحالية", en: "Current heavy-maintenance check state" },
  "copilot.suggest.rosters_sub": { ar: "تعيينات الجداول القادمة من LEON", en: "Upcoming roster assignments from LEON" },
  "copilot.footnote": { ar: "كل إجابة مدعومة ببيانات تحمل سطر مصدرها من LEON.", en: "Every data-backed answer carries its LEON source line." },
  "copilot.copy": { ar: "نسخ", en: "Copy" },
  "copilot.copied": { ar: "تم النسخ", en: "Copied" },
  "copilot.new_chat": { ar: "محادثة جديدة", en: "New chat" },
  "copilot.suggestions_label": { ar: "اقتراحات", en: "Suggestions" },
