  ...
  return (
    <div className="dark min-h-screen w-full bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 surface-gradient opacity-60" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,oklch(0.62_0.22_25/0.15),transparent_70%)]" />
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32 text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-3">
            ...
            <Link
              to="/auth"
              className="inline-flex items-center gap-2 h-11 px-6 rounded-md border border-border bg-card/40 text-foreground font-medium hover:bg-card transition-colors"
            >
              Sign in
            </Link>
          </div>
      ...
      <footer className="border-t border-border/60 bg-background">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            <div className="size-6 rounded-md brand-gradient grid place-items-center">
