...
export const dict = {
  ...
  // shell
  "shell.nav.workspace": { ar: "مساحة العمل", en: "Workspace" },
  "shell.brand.tagline": { ar: "مجموعة أدوات الطيران", en: "Aviation Toolkit" },
  "shell.brand.logo_alt": { ar: "شعار ريد سي", en: "REDSEA logo" },
  "shell.release": { ar: "الإصدار 0.1 · المرحلة الأولى", en: "v0.1 · Phase 1" },
  "shell.skip_to_main": { ar: "انتقل إلى المحتوى الرئيسي", en: "Skip to main content" },
  "shell.navigation": { ar: "التنقل الرئيسي", en: "Main navigation" },
  "shell.navigation_description": {
    ar: "روابط مساحة العمل والوحدات والإدارة",
    en: "Workspace, module, and administration links",
  },
  "shell.open_navigation": { ar: "فتح قائمة التنقل", en: "Open navigation menu" },
  "shell.collapse_navigation": { ar: "طي شريط التنقل", en: "Collapse navigation rail" },
  "shell.expand_navigation": { ar: "توسيع شريط التنقل", en: "Expand navigation rail" },
  "shell.current_page": { ar: "الصفحة الحالية", en: "Current page" },
  // topbar
  "top.search_placeholder": { ar: "ابحث في الملفات والمهام…", en: "Search files, tasks, jobs…" },
  "top.search_label": { ar: "البحث في الملفات والمهام", en: "Search files and tasks" },
  "top.signout": { ar: "تسجيل الخروج", en: "Sign out" },
  "top.signed_in": { ar: "مسجل الدخول", en: "Signed in" },
  "top.language_switch": { ar: "التبديل إلى الإنجليزية", en: "Switch to Arabic" },
  "top.language_target_short": { ar: "EN", en: "ع" },
  "top.notifications": { ar: "الإشعارات", en: "Notifications" },
  "top.account_menu": { ar: "فتح قائمة الحساب", en: "Open account menu" },
  "top.role": { ar: "الدور: {role}", en: "Role: {role}" },
  // modules
  ...
  // dashboard
  "dash.welcome": { ar: "مرحباً بعودتك", en: "Welcome back" },
  "dash.live_monitor": { ar: "متابعة المهام لحظياً", en: "Live job monitor" },
  "dash.jobs_history": { ar: "المهام · آخر {days} يوم", en: "Jobs · last {days} days" },
  "dash.status_mix": { ar: "توزيع الحالات", en: "Status mix" },
  "dash.total": { ar: "الإجمالي", en: "Total" },
  "dash.recent_jobs": { ar: "أحدث المهام", en: "Recent jobs" },
  "dash.recent_uploads": { ar: "أحدث الملفات", en: "Recent uploads" },
  "dash.no_jobs": { ar: "لا توجد مهام بعد.", en: "No jobs yet." },
  "dash.no_uploads": { ar: "لا توجد ملفات.", en: "No uploads." },
  "dash.all": { ar: "الكل", en: "All" },
  "dash.module_usage": { ar: "استخدام الموديولات", en: "Module usage" },
  // jobs
  "jobs.title": { ar: "قائمة المهام", en: "Job Queue" },
  "jobs.subtitle": {
    ar: "متابعة لحظية لجميع المهام الخلفية.",
    en: "Live monitor for background processing jobs.",
  },
  "jobs.live": { ar: "مباشر", en: "Live" },
  "jobs.filter_label": { ar: "تصفية حسب الحالة", en: "Filter by status" },
  "jobs.filter_all": { ar: "الكل", en: "All" },
  ...
  "jobs.status.done": { ar: "مكتملة", en: "Done" },
  "jobs.status.failed": { ar: "فشلت", en: "Failed" },
  "jobs.status.cancelled": { ar: "ملغاة", en: "Cancelled" },
  "jobs.toast.completed": { ar: "اكتملت المهمة", en: "Job completed" },
  "jobs.toast.failed": { ar: "فشلت المهمة", en: "Job failed" },
  "jobs.no_file": { ar: "لا يوجد ملف", en: "No downloadable file" },
  "jobs.download": { ar: "تحميل", en: "Download" },
  "jobs.download_failed": { ar: "فشل التحميل", en: "Download failed" },
  "jobs.retry": { ar: "إعادة", en: "Retry" },
  "jobs.cancel": { ar: "إلغاء", en: "Cancel" },
  "jobs.cancel_sent": { ar: "تم إرسال طلب الإلغاء", en: "Cancel requested" },
  "jobs.retry_sent": { ar: "أُعيدت المهمة إلى قائمة الانتظار", en: "Job requeued" },
  "jobs.cancelling": { ar: "جارٍ الإلغاء…", en: "Cancelling…" },
  "jobs.attempt": { ar: "المحاولة {n}", en: "Attempt {n}" },
  "jobs.action_failed": { ar: "تعذّر تنفيذ الإجراء", en: "The action could not be completed" },
  // crew hours
  ...
  "crew.table.augmented_heavy": { ar: "التعزيز (Heavy)", en: "Augmented (Heavy)" },
  "crew.augmented.yes": { ar: "نعم", en: "Yes" },
  ...
  "crew.heavy.conflict": { ar: "تعارض: LEON له الأولوية", en: "Conflict: LEON takes precedence" },
  "crew.heavy.unavailable": {
    ar: "بيانات مصدر Heavy غير متاحة",
    en: "Heavy provenance unavailable",
  },
  "crew.heavy.unknown_resolution": {
  ...
  // copilot
  "copilot.launcher": { ar: "اسأل RedSea Copilot", en: "Ask RedSea Copilot" },
  "copilot.beta": { ar: "BETA", en: "BETA" },
  "copilot.title": { ar: "RedSea Copilot", en: "RedSea Copilot" },
  "copilot.subtitle": { ar: "يقرأ مباشرة من LEON", en: "reads live from LEON" },
  "copilot.close": { ar: "إغلاق المساعد", en: "Close assistant" },
  "copilot.thread_label": { ar: "محادثة المساعد", en: "Assistant conversation" },
  "copilot.role.you": { ar: "أنت", en: "You" },
  "copilot.role.copilot": { ar: "المساعد", en: "Copilot" },
  "copilot.empty": {
    ar: "اسأل عن ساعات الطاقم أو حالة Heavy أو الجداول. كل إجابة مبنية على بيانات هتلاقي معاها سطر المصدر من LEON.",
    en: "Ask about crew hours, Heavy status, or rosters. Every data-backed answer carries its LEON source line.",
  },
  "copilot.thinking": { ar: "جارٍ الاستعلام من LEON…", en: "Querying LEON…" },
  "copilot.error": { ar: "تعذر الوصول إلى LEON.", en: "LEON could not be reached." },
  "copilot.not_connected": {
    ar: "المساعد غير موصول بـ LEON بعد. لا توجد نتيجة يمكن الاعتماد عليها.",
    en: "Copilot is not connected to LEON yet. No answer can be trusted until it is.",
  },
  "copilot.source_label": { ar: "المصدر", en: "Source" },
  "copilot.input_label": { ar: "اكتب سؤالك", en: "Type your question" },
  "copilot.input_placeholder": { ar: "اسأل عن رحلة أو طاقم…", en: "Ask about a flight or crew…" },
  "copilot.send": { ar: "إرسال", en: "Send" },
  "copilot.tone.heavy": { ar: "Heavy", en: "Heavy" },
  "copilot.tone.resolved": { ar: "تم الحل", en: "Resolved" },
  "copilot.tone.unresolved": { ar: "غير محسوم", en: "Unresolved" },
  "copilot.chip.crew_hours": { ar: "ساعات الطاقم", en: "Crew hours" },
  "copilot.chip.crew_hours_question": {
    ar: "كم ساعة سجلها الطاقم هذا الشهر؟",
    en: "How many hours has the crew logged this month?",
  },
  "copilot.chip.heavy_status": { ar: "حالة Heavy", en: "Heavy status" },
  "copilot.chip.heavy_status_question": {
    ar: "هل هذه الرحلة Augmented (Heavy)؟",
    en: "Is this flight Augmented (Heavy)?",
  },
  "copilot.chip.rosters": { ar: "الجداول", en: "Rosters" },
  "copilot.chip.rosters_question": {
    ar: "مين على الجدول غدًا؟",
    en: "Who is on the roster tomorrow?",
  },
