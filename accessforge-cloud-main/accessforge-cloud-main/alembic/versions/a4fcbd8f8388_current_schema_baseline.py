...
def upgrade() -> None:
    ...
    sa.Column('job_title', sa.Unicode(length=255), nullable=True),
    ...
    sa.Column('actor_name', sa.Unicode(length=255), nullable=True),
    ...
    sa.Column('error_message', sa.UnicodeText().with_variant(sa.Unicode(), 'mssql'), nullable=True),
    ...
    sa.Column('body', sa.UnicodeText().with_variant(sa.Unicode(), 'mssql'), nullable=True),
    ...
    sa.Column('description', sa.UnicodeText().with_variant(sa.Unicode(), 'mssql'), nullable=True),
    sa.Column('status', sa.String(length=32), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('user_id', sa.String(length=36), nullable=True),
    sa.Column('original_name', sa.Unicode(length=512), nullable=True),
